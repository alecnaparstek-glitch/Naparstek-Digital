  ...
  return (
    ...
    >
      <div className="col-span-12 md:col-span-2 flex md:block items-center gap-4">
        <span className="font-heading text-5xl md:text-7xl font-medium text-[#F5F5F5]">{step.num}</span>
      </div>
      <div className="col-span-12 md:col-span-4">
        <h2 className="font-heading text-3xl md:text-5xl font-medium tracking-tight">{step.title}</h2>
      </div>
      <div className="col-span-12 md:col-span-6 flex items-center">
        <p className="text-base md:text-xl leading-relaxed text-[#9A9A9A]">{step.desc}</p>
      </div>
    </motion.div>
  );
};
      ...
      <div className="mx-auto max-w-[1400px] px-6 md:px-10">
        <section className="grid grid-cols-12 gap-8 pb-16 md:pb-24">
          <div className="col-span-12 lg:col-span-8">
            <Reveal>
              <p className="text-xs uppercase tracking-[0.3em] text-[#9A9A9A]">The Process</p>
            </Reveal>
            <div className="mt-6 overflow-hidden">
              ...
              >
                From idea to <span className="font-accent italic font-normal text-[#9A9A9A]">launch.</span>
              </motion.h1>
            </div>
          </div>
